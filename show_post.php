...
class Post_view {
    ...
    public function printar() {
        ...
        $sortida .= html_writer::tag('th', get_string('name', 'local_textanalysis'), ['class' => 'col-3 pl-4']);
        $sortida .= html_writer::tag('th', get_string('discussion', 'local_textanalysis'), ['class' => 'col-4 pl-4']);
        $sortida .= html_writer::start_tag('th', ['class' => 'col-3 pl-4']);
        $sortida .= html_writer::tag('span', get_string('polarity', 'local_textanalysis').' / ');
        $sortida .= html_writer::tag('span', get_string('language', 'local_textanalysis'));
        ...
        foreach ($posts as $key => $value) {
            ...
            if (is_object($name)) {
                ...
                $sortida .= html_writer::tag('a', get_string('notFound', 'local_textanalysis'), ['class' => 'col-3' ]);
            }
